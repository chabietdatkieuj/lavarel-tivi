...
<style>
  ...
  /* Buttons (giữ class cũ, đổi style cho hợp layout) */
  .btn-update{
    background: var(--primary-600); color:#fff; font-weight:600; border:none;
  }
  ...
  .btn-clear{
    background:#111827; color:#fff; font-weight:700; border:none;
  }
  ...
  /* Responsive: ảnh nhỏ lại ở màn hẹp */
  @media (max-width: 576px){
    .img-thumb{ width:70px; height:48px }
  }
</style>
@endpush
...
<div class="container my-4">
  ...
  @else
      ...
      {{-- CTA Thanh toán (giữ logic/route) --}}
      <div class="text-end mt-3">
          <a href="{{ route('checkout.create') }}" class="btn btn-gold btn-lg">
              💳 Thanh toán
          </a>
      </div>

      {{-- Lịch sử mua hàng gần đây (không đổi) --}}
