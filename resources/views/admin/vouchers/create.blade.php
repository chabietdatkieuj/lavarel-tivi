...
@section('content')
<h2 class="fw-bold mb-3">+ Thêm voucher</h2>
<form method="POST" action="{{ route('admin.vouchers.store') }}" class="card p-3">
  @csrf
  <div class="row g-3">
    <div class="col-md-3">
    ...
    <div class="col-md-3">
      ...
      <input type="checkbox" name="is_active" value="1" checked> Đang bật
    </div>
    <div class="col-md-6">
